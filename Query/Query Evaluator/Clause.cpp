...
Clause::Clause() {
	...
	isFirstArgIntercept = false;
	isSecondArgIntercept = false;
	isMainArgIntercept = false;
...
int Clause::getNumOfIntercept() {
	return numOfIntercept;
}
...
bool Clause::getIsSubExpr() {
	return isSubExpr;
}

void Clause::setnumOfIntercept(int num) {
	numOfIntercept = num;
}
